angular.module('templates-app', ['app/about/about.tpl.html', 'app/home/home.tpl.html', 'app/main.tpl.html']);

angular.module("app/about/about.tpl.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("app/main.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/main.tpl.html",
    "<div class=\"header\">\n" +
    ...
    "  </ul>\n" +
    "  <h3 class=\"text-muted\">angular enterprise seed</h3>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"jumbotron\">\n" +
    "  <h1>'Allo, 'Allo!</h1>\n" +
